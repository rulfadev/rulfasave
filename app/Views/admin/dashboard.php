...
<body>
                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxOne"
                                                        class="text-base ml-2 text-slate-600">Design a FreshCart Home
                                                        page</label>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxTwo" class="text-base ml-2 text-slate-600">Dash
                                                        UI Dark Version Design</label>
                                                </div>
                                            </td>
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                Yesterday</td>
                                            ...
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxThree"
                                                        class="text-base ml-2 text-slate-600">Dash UI landing page
                                                        design</label>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    ...
                                                    <label for="checkboxSix" class="text-base ml-2 text-slate-600">Coach
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">Front End
                                            Developer</td>
                                        <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">3 May, 2023
                                        </td>
                                        <td class="border-b border-gray-300 font-medium py-3 px-6 text-left">
                                            <div class="dropdown leading-4">
                                                <button
    ...
    <!-- Libs JS -->
    <script type="text/javascript" src="<?= base_url('assets/libs/feather-icons/dist/feather.min.js'); ?>"></script>
    <script type="text/javascript"
        src="<?= base_url('assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js'); ?>"></script>
    <script type="text/javascript" src="<?= base_url('assets/libs/simplebar/dist/simplebar.min.js'); ?>"></script>

    <!-- Theme JS -->
    <script type="text/javascript" src="<?= base_url('assets/js/theme.min.js'); ?>"></script>
