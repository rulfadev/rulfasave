  ...
  <div class="bg-white rounded-lg shadow-lg flex max-w-4xl w-full overflow-hidden">
    ...
    <div class="w-full md:w-1/2 p-8 m-auto">
        ...
        <?php if ($errors = session()->get('errors')): ?>
          <?php foreach (json_decode($errors) as $error): ?>
        ...
        <form action="<?= base_url('auth/register'); ?>" method="post">
            <div class="mb-4">
                ...
                <input type="text" id="username" name="username" class="w-full p-3 rounded border border-gray-300 focus:outline-none focus:border-blue-500" required>
            </div>
            <div class="mb-4">
                <label for="email" class="block text-gray-700">Email</label>
                <input type="email" id="email" name="email" class="w-full p-3 rounded border border-gray-300 focus:outline-none focus:border-blue-500" required>
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6">
                <label for="confirmpassword" class="block text-gray-700">Ulangi Kata Sandi</label>
                <input type="password" id="confirmpassword" name="confirmpassword" class="w-full p-3 rounded border border-gray-300 focus:outline-none focus:border-blue-500" required>
            </div>
            <div class="flex items-center mb-6">
                <input type="checkbox" id="tor" name="tor" value="1" class="h-4 w-4 text-blue-500 focus:ring-blue-400 border-gray-300 rounded mr-2">
                <label for="tor" class="ml-2 text-gray-700 text-sm">Saya setuju untuk mematuhi <a href="#" class="font-bold border-b border-gray-500 border-dotted">
                  Ketentuan Layanan</a> dan <a href="#" class="font-bold border-b border-gray-500 border-dotted">
                  Kebijakan Privasi</a>.</label>
            </div>
            ...
            <p class="mt-6 text-xs text-gray-600 text-center">
                ...
                <a href="<?= base_url('auth/login'); ?>" class="border-b border-gray-500 border-dotted font-bold">
                    Masuk Sekarang
                </a>
            </p>
        </form>
